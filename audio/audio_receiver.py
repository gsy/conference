...
# Todo: detect from the RTP Source element inside the GstRtpBin
...
pipeline.add(rtpbin, udpsrc_rtpin, udpsrc_rtcpin, udpsink_rtcpout,
             audioconvert, rtpvorbisdepay, q1, vorbisdec, autoaudiosink)
...
gst.element_link_many(rtpvorbisdepay, q1, vorbisdec, audioconvert, autoaudiosink)

def start():
    pipeline.set_state(gst.STATE_PLAYING)
    udpsink_rtcpout_set_locked_state(gst.STATE_PLAYING)
    print 'Started...'
